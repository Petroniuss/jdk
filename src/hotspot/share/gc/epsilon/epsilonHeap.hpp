...
public:
  ...
  // MarkCompact does not support ObjectPinning - all objects can be moved..
...
private:
  ...
  // walking bitmap and processing roots closures.
  void vmentry_collect(GCCause::Cause casue);
